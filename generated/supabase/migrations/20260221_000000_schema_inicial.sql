...
COMMENT ON TABLE vigia_companies IS 'Customers of VigIA';
COMMENT ON TABLE vigia_users IS 'Telegram users';
COMMENT ON TABLE vigia_entries IS 'Daily financial entries';
COMMENT ON TABLE vigia_receivables IS 'Accounts receivable';
COMMENT ON TABLE vigia_subscriptions IS 'Monthly subscription payments';
COMMENT ON TABLE vigia_message_logs IS 'Telegram message audit trail';
COMMENT ON TABLE vigia_alerts IS 'Cash alert history';
...
-- COMMENT ON COLUMN vigia_companies.phone IS 'SMS contact phone (future)';

-- Emergency rollback (drops MVP schema, data cleared)
-- ==========================================
